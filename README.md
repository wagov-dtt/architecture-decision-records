...
- TODO: [005-secrets-management.md](security/005-secrets-management.md) - Use K8S Sealed Secrets or AWS Secrets Manager for storage, only accessed transiently as needed
...
- TODO: [007-logging.md](operations/007-logging.md) - Collect relevant security logs into [centralised SIEM tooling](https://soc.cyber.wa.gov.au/onboarding/sentinel-guidance/), and minimise logging of sensitive information.
