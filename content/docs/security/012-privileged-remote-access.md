...
description: "Traditional privileged access methods using jump boxes, bastion hosts,"
weight: 120
toc: true
---
...
```mermaid
flowchart LR
    admin["Administrator"] -->|MFA + identity| ssm["Session Manager"]
    ssm -->|temporary session| systems["Target Systems"]
```
