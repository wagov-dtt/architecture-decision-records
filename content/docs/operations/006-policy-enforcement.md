...
description: "Cloud infrastructure requires automated policy enforcement to prevent"
weight: 60
toc: true
---
...
```mermaid
flowchart LR
    governance["Governance"] -->|policies| network["Network Security"]
    network -->|access control| workloads["Workloads"]
```
