...
4. **Setup Database** - Follow [ADR 018: Database Patterns](../operations/018-database-patterns.qmd) for Aurora Serverless v2 as data warehouse
...
4. **Data Governance** - Follow [ADR 015: Data Governance Standards](../operations/015-data-governance.qmd) for SQLMesh data contracts and lineage
...
3. **Analytics Tools** - Follow [ADR 017: Analytics Tooling Standards](../operations/017-analytics-tooling.qmd) for Quarto and Evidence BI integration
...
- Implement PII handling, data classification, and retention policies per [ADR 015: Data Governance Standards](../operations/015-data-governance.qmd)
