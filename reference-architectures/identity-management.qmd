...
1. **Infrastructure Foundation** - Follow [ADR 001: Application Isolation](../security/001-isolation.qmd), [ADR 002: AWS EKS for Cloud Workloads](../operations/002-workloads.qmd), and [ADR 019: Database Patterns](../operations/019-database-patterns.qmd) for identity service deployment and data separation
...
4. **Zero Trust Administration** - Follow [ADR 018: Zero Trust Remote Access](../security/018-zero-trust-access.qmd) for identity service administration access
